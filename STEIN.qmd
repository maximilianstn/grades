...
### 
```{r}
grades_group_distribution <- martial_arts_grades %>%
  count(group, num_grades)

ggplot(grades_group_distribution, aes(x = group, y = n, fill = factor(num_grades))) +
  geom_col() +
  labs(
    title = "Number of Students by Number of Grades and Group",
    x = "Group",
    y = "Number of Students",
